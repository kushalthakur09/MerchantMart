...
public class ApiConstants {
    public final static String STORE_DELETED_SUCCESSFULLY="Store deleted successfully";
    ...
    public static final String REFUND_DELETED_SUCCESSFULLY = "Refund deleted successfully";
}
